...
<section class="relative min-h-screen flex items-center justify-center overflow-hidden" id="hero">
    ...
    <div class="absolute inset-0 z-0">
        <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80" 
             alt="Steel fabrication background" 
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
            ...
            <div class="space-y-8">
                    ...
                    <div class="space-y-6">
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100">123 Industrial Avenue<br>Steel City, SC 12345</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100">+1 (555) 123-STEEL<br>+1 (555) 123-7833</p>
                            </div>
                        </div>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-blue-100">info@agolosteelworks.com<br>quotes@agolosteelworks.com</p>
                            </div>
                        </div>
                ...
                <!-- Emergency Contact -->
                <div class="bg-red-600/90 backdrop-blur-sm rounded-xl p-6 border border-red-400">
                    ...
                    <p class="text-white font-semibold">+1 (555) 911-STEEL</p>
                </div>
            </div>
        </div>
    </div>
